    ...
    return (
        <div className="flex flex-col w-full px-[5%] justify-center py-24 gap-12">
            ...
            <div className="flex flex-col md:flex-row">
                ...
                >
                    <div>
                        Professional Network for Engineering Services Pvt. Ltd. (PNet) is an engineering consulting firm dedicated to
                        providing customized technical consultancy in planning, design, and implementation of engineering projects across
                        various sectors.
                    </div>
                    <div>
                        PNet excels in civil engineering infrastructure with a focus on excellence, innovation, and sustainability. Their
                        team of seasoned engineers and consultants use cutting-edge technology to deliver tailored strategies for
