        ...
        <footer className="flex flex-col w-full px-[5%]">
            ...
            <div className='flex justify-between w-full'>
                ...
                <div className='flex items-center gap-6'>
                    ...
                    <a href="" className='p-5 text-sm font-bold text-white duration-300 rounded-full bg-primary hover:bg-primary/90'>
                        <FaArrowUp className='text-xl font-bold' />
                    </a>
                </div>
            </div>
            {/* Details */}
            <div className='flex items-center justify-between w-full py-8 my-12 text-lg text-white px-[5%] rounded-xl bg-primary font-manrope'>
