...
const LandingMissionVision = () => {
    return (
        <div className='flex md:flex-row flex-col w-full divide-y md:divide-y-0 px-[5%] bg-primary py-24 text-white md:divide-x'>
            <div className='flex flex-col items-center gap-4 pb-12 md:px-12 md:w-1/2 md:pb-0'>
            ...
            <div className='flex flex-col items-center gap-4 pt-12 md:px-12 md:w-1/2 md:pt-0'>
