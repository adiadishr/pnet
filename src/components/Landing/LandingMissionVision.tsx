...
const LandingMissionVision = () => {
    return (
        <div className='flex md:flex-row flex-col w-full divide-y md:divide-y-0 px-[5%] bg-primary pb-24 pt-36 text-white md:divide-x'>
            <div data-aos-delay='100' data-aos='fade-up' className='flex flex-col items-center gap-4 pb-12 md:px-12 md:w-1/2 md:pb-0'>
            ...
            <div data-aos-delay='200' data-aos='fade-up' className='flex flex-col items-center gap-4 pt-12 md:px-12 md:w-1/2 md:pt-0'>
