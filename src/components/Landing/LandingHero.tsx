            ...
            <div className='static' data-aos='fade-up'>
                ...
                <div className="mt-[60px] min-h-[calc(100vh-60px)] flex md:flex-row flex-col md:justify-start justify-center md:items-center px-[5%] text-white">
                    <div className="flex flex-col gap-6 md:w-1/2">
                        <h1 data-aos-delay='100' data-aos='fade-right' className="font-bold uppercase text-5xl/snug font-poppins">
                            Your Vision,<br /> <span className='text-primary brightness-150'>Our Expertise</span>
                        </h1>
                        <div data-aos-delay='200' data-aos='fade-right' className='flex flex-col gap-4 divide-y text-lg/loose font-manrope'>
                            <p className='w-2/3'>
                    ...
                    <div className="flex mt-10 md:justify-center md:w-1/2 md:mt-0">
                        <a data-aos-delay='300' data-aos='fade-left' href='#serviceAnchor' className='px-16 py-4 text-lg duration-300 border border-white cursor-pointer hover:bg-white hover:text-black font-manrope'>
                            Find out more
                        </a>
                    </div>
                </div>
