...
const LandingNewsletter = () => {
    return (
        <div className='flex flex-col py-24 items-center w-full px-[5%] gap-4'>
            ...
            <p data-aos-duration='700' data-aos='fade-up' data-aos-delay='200' className='text-lg text-center font-manrope'>20 Years of Excellence in Client-Oriented Infrastructure Solutions</p>
