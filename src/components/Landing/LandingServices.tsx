...
const LandingServices = () => {
    return (
        <div id='serviceAnchor' className="flex flex-col min-h-screen bg-neutral px-[5%] w-full pb-24">
            <div data-aos='fade-up' className='flex flex-col items-center w-full gap-4 py-20 mt-4'>
            ...
            <div className='grid w-full grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-x-12 gap-y-16'>
                {services.map((service) => (
                    <div data-aos='fade-up' data-aos-delay={service.delay} className='flex flex-col overflow-hidden bg-white shadow-xl rounded-3xl group' key={service.title}>
                        <div className='w-full overflow-hidden'><img src={service.url} alt={service.alt} className='flex w-full duration-500 hover:scale-110' /></div>
